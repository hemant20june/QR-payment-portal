...
export class AppComponent implements AfterViewInit {
  ...
  ngAfterViewInit(){
    ...
    this.form3 = this.stepOneComponent.frmStepOne;
    this.form4 = this.stepTwoComponent.frmStepTwo;
    this.cdr.detectChanges();
  }

  isNameValid() {
    return this.form1.pristine || this.form1.valid || this.form2.pristine || this.form2.valid
